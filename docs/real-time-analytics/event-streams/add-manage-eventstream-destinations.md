...
1. Enter a name for the eventstream destination and complete the information about your Reflex.
   ...
   :::image type="content" source="./media/add-manage-eventstream-destinations/eventstream-destination-reflex-configuration.png" alt-text="Screenshot showing the reflex configuration." lightbox="./media/add-manage-eventstream-destinations/eventstream-destination-relex-configuration.png" :::
