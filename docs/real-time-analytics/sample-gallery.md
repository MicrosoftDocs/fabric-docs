...
Real-Time Analytics in Microsoft Fabric offers a sample data gallery containing data in various formats and sizes for you to practice loading and and writing queries. Each dataset in the **Real-Time Analytics Sample Gallery** is loaded into your workspace as a KQL database with an attached KQL queryset containing sample queries unique to the dataset you selected.
