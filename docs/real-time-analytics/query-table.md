...
1. Select a single query to populate the **Check your data** window. The query will automatically run and display results.
    ...
    :::image type="content" source="media/query-table/run-query.png" alt-text="Screenshot of the Check your data window showing query results of sample queries in Real-Time Analytics."  lightbox="media/query-table/run-query.png":::
