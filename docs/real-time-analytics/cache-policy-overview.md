...
description: This article describes the cache policy in Real-Time Analytics.
...
<!-- #TODO: sort out mentions of Azure blob storage + cluster-->

Real-Time Analytics uses a multi-tiered data cache system to ensure fast query performance. Data is stored in reliable storage, such as Azure Blob Storage, but parts of it are cached on processing nodes, SSD, or even in RAM for faster access.
...
Use management commands to alter the cache policy at the [database](/azure/data-explorer/kusto/management/alter-database-cache-policy-command?context=/fabric/context/context), [table](/azure/data-explorer/kusto/management/alter-table-cache-policy-command?context=/fabric/context/context), or [materialized view](/azure/data-explorer/kusto/management/alter-materialized-view-cache-policy-command?context=/fabric/context/context) level.
...
other 28 days of data will be stored in Azure blob storage.
