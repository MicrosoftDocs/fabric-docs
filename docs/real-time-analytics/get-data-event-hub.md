...
1. Fill out the **Connection settings** according to the following table:
    ...
    | Connection name | The name of your new cloud connection. This name is autogenerated, but can be overwritten. Must be unique within Fabric. | *Connection*
    | Authentication kind | Autopopulated | *Shared Access Key*
