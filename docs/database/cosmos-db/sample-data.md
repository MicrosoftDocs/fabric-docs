...
description: Explore the sample data set and schema that is available for use in to the Cosmos DB database workload within Microsoft Fabric.
author: seesharprun
...
# Sample data set in Cosmos DB in Microsoft Fabric
