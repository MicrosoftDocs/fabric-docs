...
1. Install the azure-cosmos package in your notebook. This should be version 4.14.0 or later.
...
1. Import the packages into your notebook. In this and other samples we use the async library for Cosmos DB. Then apply the Cosmos DB endpoint, database name and container name you saved in a previous step.
