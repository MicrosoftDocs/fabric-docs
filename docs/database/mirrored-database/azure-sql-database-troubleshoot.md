...
| Fabric trial capacity expired |  Mirroring stops automatically | [Refer this page for details to extend Fabric capacity](/fabric/get-started/fabric-trial#the-trial-expires) |
