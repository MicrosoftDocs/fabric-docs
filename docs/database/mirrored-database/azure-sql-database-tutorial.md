...
- Fabric capacity needs to be active and running. Paused and/or Deleted capacity will impact Mirroring and no data will be replicate from Azure SQL database to Fabric
