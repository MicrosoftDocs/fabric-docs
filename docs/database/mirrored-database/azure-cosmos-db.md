...
> For Microsoft Entra ID authentication, the following RBAC permissions are required:
    ...
    To learn more, please visit our [data plane role-based access control documentation](https://learn.microsoft.com/azure/cosmos-db/nosql/how-to-grant-data-plane-access?tabs=custom-definition%2Ccsharp&pivots=azure-interface-cli).
