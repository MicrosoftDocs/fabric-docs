...
:::image type="content" source="media/analyze-data-with.png" alt-text="Screenshot of the Analyze data with button expanded to see the SQL analytics endpoint and Eventhouse endpoint options.":::
