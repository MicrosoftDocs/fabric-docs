...
- Your **F64 or P1 capacity** needs to be in one of the regions listed in [Fabric region availability](../admin/region-availability.md).
...
- Copilot in Microsoft Fabric isn't supported on trial SKUs. Only paid SKUs (F64 or higher, or P1 or higher) are supported at this time.
