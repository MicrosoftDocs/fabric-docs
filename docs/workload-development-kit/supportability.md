...
Fabric exposes two important headers in [requests](/rest/api/fabric/workload/fabricextensibilitytoolkit/item-lifecycle/on-create-item?tabs=HTTP) made between the customer and Fabric, which are crucial for supportability:
