...
To be able to work with those APIs we will need to exchange tokens for the following scopes (you can find scopes needed for each API [here](/rest/api/fabric/articles/using-fabric-apis): 
