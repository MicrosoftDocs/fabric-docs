...
- Filenames must conatin alphanumeric characters or hyphens only and cannot exceed a length of 32 characters. Using other characters or exceeding this length will result in an upload error.
