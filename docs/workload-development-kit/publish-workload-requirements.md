...
| Category | Description | Certification method  | Public Preview | General Availability | Reference  |
|---|---|---|---|---|---|
| Application lifecycle managment (ALM) | Microsoft Fabric's lifecycle management tools enable efficient product development, continuous updates, fast releases, and ongoing feature enhancements. | Attestation | Not Supported | Not Supported | [ALM in Fabric](../cicd/cicd-overview.md) |
