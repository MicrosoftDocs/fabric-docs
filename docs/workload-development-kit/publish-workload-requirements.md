...
| Monetization | You can leverage the Azuer Markeplace to monetize your workload. | Attestation | Not Supported | Optional | [Monetize your workload](monetization.md) |
...
| Item Creation Experience | Partners need to comply to the Item creation experience according to the Fabric UX System. | Attestation | Required | Required | [Fabric UX System](https://aka.ms/fabricux) |
...
| Trial Experience | Partners are required to provide a Trial Experience for users as outlined in the design guidelines.  | Attestation | Optional | Required | [Fabric Templates](http://aka.ms/fabrictemplates) | 
| Monetization Experience | Partnes that want to monetize their soltuion in fabric need to follow the patterns that have been defined in the Fabric Templates. Monetizaiton can happen through Azuer Marketplace or you can leverage your existing methods. In any case youneed to follow the design guideliens defined in the Fabric templates. | Attestation | Optional | Required | [Fabric Templates](http://aka.ms/fabrictemplates) |
| Accessibility | Partners need to comply with the Fabric UX design guiedelines for Accessibility. | Attestation | Optional | Required | [Fabric UX System](https://aka.ms/fabricux) |
| World Readiness | You have to have english as a default language. Content can be localiced if you decide to do it. In this case add the supported languages to your certification page. | Workload Package | Optional | Required | [Localization](./localization.md) |
| Jobs to be done | To be listed in different create experiences within Fabric you need to onboard to the Jobs to Be done defininition for your Item types.  | Workload Package | Optional | Required | |
...
| Samples | Partners can leverage samples that are creating preconfigured items of their type to help customers get started more easily. | Attestation | Optional | Optional | |
| Custom Item actions | Partners can implement custom actions as part of their item editor. | Attestation | Optional | Optional | |
| Workspace settings | Workspace settings provides a way that workloads can be configured on a workspace level.  | Attestation | Not supported | Not supported | [Workspace](../get-started/workspaces.md) |
| Gloabl Search | Searching for items in Fabric is supported through the top search bar.   | Attestation | Not supported | Not supported | [Fabric Search](../get-started/fabric-search.md) |

## Security & Compliance requirements

| Category | Description | Certification method | Public Preview | General Availability  | References  |
|---|---|---|---|---|---|
| Security general | Microsoft customers entrust Fabric with their most sensitive data. As partners implementing workloads can have access to data on it they also have a responsibility to protect that data. To that end we request workloads to  goe through a security assessment, a security review and attest that they dit it. discovered in the process. <br><br> *Addtional requirements:* <br>  | Attestation | Optional | Requried | [Secure, protect and comply](../governance/governance-compliance-overview#secure-protect-and-comply) |
| | Before calling any JS functions exposed by Fabric, ISV must first obtain user Entra ID token from the Fabric host. | Attestation | Required | Required | |
| Privacy | Microsoft customers entrust Fabric  with their most sensitive data. As such, partners tht build workloads also have a responsibility to protect that data when they access it. To that end we request that every workload goes through a privacy assessment and a privacy review. <br><br> *Addtional requirements:* <br>  | Attestation | Optional | Required | [Secure, protect and comply](../governance/governance-compliance-overview#secure-protect-and-comply) |
||ISV may use only essential HTTP-only cookies.  ISV may use them only after positively authenticating the user. | Attestation | Required | Required | [Cookie compliance - Commerce](https://learn.microsoft.com/en-us/dynamics365/commerce/cookie-compliance) |
| Data Residency | Fabric is making a Enterprise Promise around data residency not leaving the geography of the tenant not only for stored data but also for data in transit. As a workload you are showing up in Fabric directly and users need to be aware what your commitments to Data Residency are. In the attestation you need to define what our commitments are to the Data Residency of customer data.  | Attestation | Optional | Requried | [Data residency in Azure](https://azure.microsoft.com/en-us/explore/global-infrastructure/data-residency/)
...
| Category | Description | Certification method | Private Preview | General Availability  | References  |
|---|---|---|---|---|---|
| Livesite | As the partner workloads are  becomming an integral part of Fabric our support teams need to be aware how you want to be contaced in case customers are reaching out to us driectly. For this you need to provide the contact details as part of the certification process to us. | Attestation | Optional | Requried |  |
| Supportability | Partners are responsilbe to define and document their support parameters (SLA. contact methods, ...). This information needs to be linked form the Workload page and should always be accessible to customers. In addtion the Marketplace criterias need to be taken into account for the listing of the SAAS offer. | Attestation | Optional | Requried | [Marketplace listing guidelines](partner-center/marketplace-offers/marketplace-criteria-content-validation) |
| Service Health & Availability | Partners need to host their a website that shows their service healt and avaialbility to customers. This information can be included in the Supportability page. | Attestation | Optional | Requried |  |

## Fabric features

| Category | Description | Certification method  | Public Preview | General Availability | Reference  |
|---|---|---|---|---|---|
| Application lifecycle managment (ALM) | Microsoft Fabric's lifecycle management tools enable efficient product development, continuous updates, fast releases, and ongoing feature enhancements. | Attestation | Not Supported | Not Supported | [ALM in Fabric](https://learn.microsoft.com/en-us/fabric/cicd/) |
| Private Links | In Fabric, you can configure and use an endpoint that allows your organization to access Fabric privately. | Attestation | Not Supported | Not supported | [Private Links](https://learn.microsoft.com/en-us/fabric/security/security-private-links-use) |
