...
After configuring your application, add the following configurations to the `extension` section of the `Frontend/Manifests/localWorkloadManifest.json` file which can be found the  [repository](https://go.microsoft.com/fwlink/?linkid=2272254).
