...
4. Enable the Fabric admin settings:
    1. Log in to the Fabric admin portal. You need to be a Power BI admin to see the tenant settings page.
...
* Power BI admin rights are required to enable service principal in the Admin API settings in the Fabric admin portal.
