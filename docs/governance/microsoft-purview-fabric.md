...
Note: Purview Hub insights are permanently moving to the Govern tab in the OneLake catalog. For more information, see [Govern Fabric data](https://learn.microsoft.com/en-us/fabric/governance/onelake-catalog-govern)
