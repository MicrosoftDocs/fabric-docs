...
:::image type="content" source="./media/external-data-sharing-create/image1.png" alt-text="Illustration of a cross-tenant OneLake data share.":::
...
:::image type="content" source="./media/external-data-sharing-create/image2.png" alt-text="Illustration of a cross-tenant OneLake data share.":::
...
:::image type="content" source="./media/external-data-sharing-create/image3.png" alt-text="Illustration of a cross-tenant OneLake data share.":::
...
:::image type="content" source="./media/external-data-sharing-create/image7.png" alt-text="Illustration of a cross-tenant OneLake data share.":::
...
:::image type="content" source="./media/external-data-sharing-create/image8.png" alt-text="Illustration of a cross-tenant OneLake data share.":::
