...
> [!IMPORTANT]
> Only queries against KQL databases within an Eventhouse are supported. If your KQL queryset is connected to an [external Azure Data Explorer cluster](../real-time-intelligence/kusto-query-set.md#select-a-data-source), creating an alert is not supported. 
