...
1. Select **View Airflow connections** to see a list of all the connections configured.
...
1. Start by selecting the **New DAG File** card. Then, assign a name to the file and select **Create**.
...
After saving, the DAG files are automatically loaded into the Apache Airflow UI. To monitor them, select **Monitor in Apache Airflow**.
