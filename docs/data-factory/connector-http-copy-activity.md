...
The following properties are supported for HTTP under **Destination** tab of a copy activity.

:::image type="content" source="./media/connector-http/destination.png" alt-text="Screenshot showing destination tab.":::
...
- **Write batch size**: Write Batch Size defaults to 10000
