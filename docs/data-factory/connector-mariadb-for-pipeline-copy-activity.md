...
This connector supports MariaDB for Pipeline version 10.x, 11.x.
...
- **Use query**: Select from **Table** or **Query**.
    - If you select **Table**:
      - **Table**: Specify the name of the table in the MariaDB for Pipeline to read data. Select the table from the drop-down list.
