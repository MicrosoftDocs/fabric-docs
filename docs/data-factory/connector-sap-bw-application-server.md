...
You can connect a dataflow Gen2 in Fabric to SAP BW Application Server by using Power Query connectors. Follow these steps to create your connection:
...
Data Factory doesn't currently support an SAP BW Application Server in pipelines.
