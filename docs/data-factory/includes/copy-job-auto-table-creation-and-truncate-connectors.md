...
| --- | --- | --- |
| Azure SQL DB | <!--Automatic table creation-->:::image type="icon" source="../media/data-pipeline-support/yes.png"::: | <!--Truncate destination-->:::image type="icon" source="../media/data-pipeline-support/yes.png"::: |
...
| Azure Synapse Analytics | <!--Automatic table creation-->:::image type="icon" source="../media/data-pipeline-support/yes.png"::: | <!--Truncate destination-->:::image type="icon" source="../media/data-pipeline-support/yes.png"::: |
