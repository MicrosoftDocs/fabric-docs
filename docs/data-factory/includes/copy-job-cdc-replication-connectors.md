...
| Oracle (Preview) | <!--CDC Source-->:::image type="icon" source="../media/data-pipeline-support/yes.png"::: | <!--CDC Destination-->:::image type="icon" source="../media/data-pipeline-support/no.png"::: | <!--SCD2-->:::image type="icon" source="../media/data-pipeline-support/yes.png"::: |
