...
| Fabric Data Warehouse | <!--CDC Source-->:::image type="icon" source="../media/data-pipeline-support/no.png"::: | <!--CDC Destination-->:::image type="icon" source="../media/data-pipeline-support/yes.png"::: | <!--SCD2-->:::image type="icon" source="../media/data-pipeline-support/no.png"::: |
