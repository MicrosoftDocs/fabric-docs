...
description: This article provides information about how to create an FHIR data connection in Microsoft Fabric.
...
This article outlines the steps to create an FHIR data connection.
