...
- The creator of Azure Key Vault reference connection, must have atleast [Key Vault Certificate User](https://learn.microsoft.com/en-us/azure/role-based-access-control/built-in-roles/security#key-vault-certificate-user) permission on the Key Vault.
