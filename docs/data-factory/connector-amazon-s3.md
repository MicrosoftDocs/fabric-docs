...
### Step 1: Specify the new connection name, type, data source path
   ...
   :::image type="content" source="media/connector-amazons3/connection-details.png" alt-text="Screenshot showing how to set new connection.":::
...
:::image type="content" source="media/connector-amazons3/authentication-method.png" alt-text="Screenshot showing that authentication method of Amazon S3":::
...
:::image type="content" source="media/connector-amazons3/basic-authentication.png" alt-text="Screenshot showing that basic authentication method of Amason S3":::
...
:::image type="content" source="./media/connector-amazons3/connection.png" alt-text="Screenshot showing connection page.":::
