---
title: Change data capture from Azure SQL DB using Copy job
description: This tutorial guides you through how to use CDC in Copy job to move data from Azure SQL DB.
ms.reviewer: yexu
ms.topic: tutorial
ms.date: 04/24/2026
...
# Change data capture from Azure SQL DB using Copy job (Preview)
