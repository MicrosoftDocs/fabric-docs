...
- Be sure to install or set up any [Azure Databricks prerequisites](/power-query/connectors/databricks-azure#prerequisites) before connecting to the Azure Databricks connector.
