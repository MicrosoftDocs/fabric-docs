...
description: Learn how to troubleshoot issues with the Azure Blob Storage connector in Fabric Data Factory.
ms.reviewer: xupzhou
...
# Troubleshoot the Azure Blob Storage connector in Fabric Data Factory

This article provides suggestions to troubleshoot common problems with the Azure Blob Storage connector in Data Factory.
