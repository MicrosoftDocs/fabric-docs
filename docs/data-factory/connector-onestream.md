...
You can connect dataflow Gen2 in Fabric to OneStream using Power Query connectors. Follow these steps to create your connection:
...
Data Factory doesn't currently support OneStream in pipelines.
