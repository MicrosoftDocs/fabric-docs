...
- This feature incurs Fabric AI Functions charges. Costs are reported under the operation name [**AI Functions**](/docs/enterprise/fabric-operations) when queries run in the data preview and during run operations.
