...
You can connect a dataflow Gen2 in Fabric to Profisee using Power Query connectors. Follow these steps to create your connection:
...
Data Factory doesn't currently support Profisee in pipelines.
