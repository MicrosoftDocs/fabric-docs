...
This article outlines how to configure delimited text format in Data Factory.
...
:::image type="content" source="./media/format-delimited-text/select-file-format.png" alt-text="Screenshot showing selecting file format.":::

- **File format**: Select **DelimitedText** from the drop-down list. 
...
- **Row delimiter**: The character used to separate rows in a file. Only one character is allowed. The default value is any of the following values：`\r`,`\n`, or `r\n`
