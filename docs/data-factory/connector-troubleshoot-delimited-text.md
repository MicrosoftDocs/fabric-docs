...
description: Learn how to troubleshoot issues with the delimited text format connector in Fabric Data Factory.
ms.reviewer: xupzhou
...
# Troubleshoot the delimited text format connector in Fabric Data Factory

This article provides suggestions to troubleshoot common problems with the delimited text format connector in Data Factory.
