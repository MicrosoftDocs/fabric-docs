...
- **Additional columns**: Add more data columns to store source files' relative path or static value. If you're using a static value, you can use [custom expressions](control-flow-expression-language-functions.md) to generate it.
