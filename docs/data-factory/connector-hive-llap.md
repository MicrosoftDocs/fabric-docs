...
You can connect dataflow Gen2 in Fabric to Hive LLAP using Power Query connectors. Follow these steps to create your connection:
...
Data Factory doesn't currently support Hive LLAP data in pipelines.
