...
- You need to have at least version **3000.210.14** or a gateway that is currently supported[(learn more)](/data-integration/gateway/service-gateway-onprem) of the gateway installed to use with Dataflow Gen2.
