...
1. Select **Create** once you complete the connection. You can also create and manage the Microsoft Fabric connection directly in the Airflow UI. You need to do that to periodically refresh your SPN secret. The following instructions don't work if you're using Git sync. In that case, you need to edit your DAG manually.
