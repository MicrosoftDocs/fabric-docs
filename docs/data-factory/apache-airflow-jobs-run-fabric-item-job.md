...
- Enable Apache Airflow Job in your Tenant.
  ...
  > [!NOTE]
  > Since Apache Airflow job is in preview, you need to enable it through your tenant admin. If you already see Apache Airflow Job, your tenant admin may have already enabled it. Additionally, make sure Apache Airflow job is available in the capacity region you are using for your workspace. For more information, see [available capacity regions](/apache-airflow-jobs-concepts.md#region-availability-public-preview).
