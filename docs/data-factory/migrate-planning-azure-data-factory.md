...
| **Global Parameters** | Global Parameters | [Fabric Variable Library](/fabric/cicd/variable-library/get-started-variable-libraries) | Different implementation patterns, though we have created [a migration guide](convert-global-parameters-to-variable-libraries.md) |
