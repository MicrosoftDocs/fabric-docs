...
This article outlines how to use the copy activity in a pipeline to copy data from and to Amazon S3.
...
For **Mapping** tab configuration, go to [Configure your mappings under mapping tab](copy-data-activity.md#configure-your-mappings-under-the-mapping-tab). If you choose Binary as your file format, mapping will not be supported.
...
|*For **Prefix*** |||||
| **Bucket** | The S3 bucket name. | \<your bucket name> |Yes|bucketName|
| **Prefix** | The prefix for the S3 key name under the given bucket to filter source S3 files. | \<your prefix> |No|prefix|
