...
description: This article describes how to set up continuous integration and delivery (CI/CD) for copy job in Fabric Data Factory.
ms.reviewer: yexu
ms.topic: how-to
ms.date: 06/20/2025
ms.custom: copy-job
...
# CI/CD for Copy job in Fabric Data Factory
...
Here are some of the current limitations when using CI/CD for copy job in Data Factory:
