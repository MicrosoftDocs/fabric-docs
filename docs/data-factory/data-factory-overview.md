...
- [dbt job](dbt-job-overview.md) - dbt job in Microsoft Fabric enable SQL-based data transformations directly within the Fabric user interface. They provide a simple, no-code setup to build, test, and deploy dbt models on top of your Fabric data warehouse.
