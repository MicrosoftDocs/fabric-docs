...
| Refresh history reports in progress for some tables while failed | [Refresh history reports in progress for some tables while failed](/known-issue-inprogress-refresh-history.md) | August 24, 2023 |
