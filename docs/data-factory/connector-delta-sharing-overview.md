---
title: Delta Sharing connector overview
description: This article provides an overview of the supported capabilities of the Delta Sharing connector.
ms.topic: how-to
ms.date: 04/06/2026
ms.custom:
  - template-how-to
...
|---------| --------| --------|
| **Dataflow Gen2** (source/-) | None | Key, OAuth (OIDC) |
