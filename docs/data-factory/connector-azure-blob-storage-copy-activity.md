...
The following properties are supported for Azure Blob Storage under **Source** tab of a copy activity.

:::image type="content" source="./media/connector-azure-blob-storage/source.png" alt-text="Screenshot showing source tab.":::

The following properties are **required**:
- **Data store type**: Select **External**.
- **Connection**:  Select an Azure Blob Storage connection from the connection list. If not exist, then create a new Azure Blob Storage connection by clicking on **New**.
...
- **File path type**: You can choose **File path**, **Prefix**, **Wildcard file path**, **List of files** as your file path type. See the configuration of each setting below：
...
The following properties are supported for Azure Blob Storage under **Destination** tab of a copy activity.

:::image type="content" source="./media/connector-azure-blob-storage/destination.png" alt-text="Screenshot showing destination tab.":::
...
To learn more information about copy activity in Azure Blob Storage, see the following table.
...
|**Delete files after completion** |The files on source data store will be deleted right after being moved to the destination store. The file deletion is per file, so when copy activity fails, you will see some files have already been copied to the destination and deleted from source while others are still on source store.|Selected or unselect|No |deleteFilesAfterCompletion|
