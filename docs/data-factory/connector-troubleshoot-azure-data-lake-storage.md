...
description: Learn how to troubleshoot issues with the Azure Data Lake Storage connector in Fabric Data Factory.
ms.reviewer: xupzhou
...
# Troubleshoot the Azure Data Lake Storage connector in Fabric Data Factory

This article provides suggestions to troubleshoot common problems with the Azure Data Lake Storage connector in Data Factory.
