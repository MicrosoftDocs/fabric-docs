...
1. From the page header in Data Factory service, select **Settings** :::image type="content" border="true" source="./media/connector-common/settings.png" alt-text="Settings gear icon"::: > **Manage connections and gateways**.
