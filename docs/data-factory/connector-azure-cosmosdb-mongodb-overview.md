...
To learn more about the copy activity configuration for Azure Cosmos DB for MongoDB in data pipelines, go to [Configure in a data pipeline copy activity](connector-azure-cosmosdb-mongodb-copy-activity.md).
