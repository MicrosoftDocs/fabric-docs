...
|**Connection**|Your MongoDB connection to the source data store.|< your MongoDB connection >|Yes|connection|
...
|**Cursor methods**|Specify the way that the underlying query is executed.|• **project**<br>• **sort**<br>• **limit**<br>• **skip**|No|cursorMethods:<br>• project<br>• sort<br>• limit<br>• skip|
|**Batch size**|Specifies the number of documents to return in each batch of the response from MongoDB instance.|< your write batch size ><br>The default value is 100|No|batchSize|
...
|:---|:---|:---|:---|:---|
|**Data store type**|Your data store type.|**External**|Yes|/|
|**Connection**|Your MongoDB connection to the destination data store.|< your MongoDB connection >|Yes|connection|
