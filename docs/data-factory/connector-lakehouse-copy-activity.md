    ...
    - If select **Files**:
        - **File path type**: You can choose **File path**, **Wildcard file path** or **List of files** as your file path type. See the configuration of each setting below：
            ...
            - **List of files**: Indicates to copy a given file set.
                - **Folder path**: Point to a folder that includes files you want to copy.
        ...
        - **Recursively**: Indicates whether the data is read recursively from the subfolders or only from the specified folder. If enabled, all files in the input folder and its subfolders will be processed recursively. This property doesn’t apply when you configure your file path type as List of files.
...
For **Mapping** tab configuration, see [Mapping](copy-data-activity.md#configure-your-mappings-under-mapping-tab). If you choose Binary as your file format, mapping will not be supported.
...
|**File path type** |You can choose **File path**, **Wildcard file path** or **List of files** as your file path type. |•**File path**<br>•**Wildcard file path**<br> •**List of files** |No |**File path**<br>•folderPath<br>•fileName<br>**Wildcard file path**<br>•wildcardFolderPath<br>•wildcardFileName<br>**List of files**<br>•fileListPath |
