...
description: Learn how to troubleshoot issues with the Azure Database for PostgreSQL connector in Fabric Data Factory.
ms.reviewer: xupzhou
...
# Troubleshoot the Azure Database for PostgreSQL connector in Fabric Data Factory

This article provides suggestions to troubleshoot common problems with the Azure Database for PostgreSQL connector in Data Factory.
