...
OneLake is the unified SaaS data lake in Microsoft Fabric and exposes an Azure Data Lake Storage Gen2 (ADLS Gen2) - compatible API surface (the `onelake.dfs.fabric.microsoft.com` endpoint with `abfss://` URIs).
