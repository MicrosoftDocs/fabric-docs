...
Currently, variable libraries are the supported option for assigning shortcut variables across environments. Other assignment methods, including REST API assignment, aren't supported.
...
1. Select **Edit target** and choose the desired property to assign the variable to.
