...
- **Fabric item** - Execute the selected Fabric pipeline, Fabric notebook, Fabric Spark Job Definition, Fabric function.
...
To create a property, select the stream added to the object that you're interested in, select **New Property** from the ribbon, and then select the property you'd like to use in the rule logic.
