...
- A skill-compatible agent — for example, GitHub Copilot CLI, GitHub Copilot in VS Code, or any other agent — with the [Fabric skills](https://github.com/microsoft/fabric-skills) installed.
