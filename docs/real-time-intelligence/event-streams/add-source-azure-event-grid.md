...
If the eventstream is marked with either **Confidential** or **Highly Confidential**, follow these steps so that the Event Grid namespace's managed identity has the appropriate acces. 
