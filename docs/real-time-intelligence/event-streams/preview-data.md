...
To preview the destination data of a KQL database, Fabric [!INCLUDE [fabric-activator](../real-time-intelligence/includes/fabric-activator.md)] or lakehouse in the eventstream:
