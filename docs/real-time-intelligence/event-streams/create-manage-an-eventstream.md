...
Before you start, complete the following prerequisite:

- Get access to a workspace in the Microsoft Fabric capacity license mode or the trial license mode with Contributor or higher permissions.
