...
Eventstreams provide you with source connectors to fetch event data from various sources. More sources are available when you enable **Enhanced capabilities** at the time of creating an eventstream.
