---
title: Manage rules for alerts on eventstreams
description: The include file shows how to manage alert rules for eventstreams, including how to stop or start a rule, edit a rule, delete a rule, open the rule in the Fabric Activator UI, and add more rules.
ms.topic: include
ms.date: 03/06/2026
---
