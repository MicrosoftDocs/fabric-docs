...
In addition, the following [tenant switches](/fabric/admin/about-tenant-settings.md) must be enabled from the Admin portal:

- [Users can use Azure Maps services](fabric/admin/map-settings.md)
