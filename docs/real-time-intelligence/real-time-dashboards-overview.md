...
| **KPI** | A tile that displays a single key metric, often with a trend indicator. | Highlight a critical metric at a glance, such as current system uptime or revenue. | ![Screenshot of a KPI visual.](media/dashboard-visuals/kpi.png) |
