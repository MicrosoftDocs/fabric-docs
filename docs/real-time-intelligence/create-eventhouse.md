...
1. The [system overview](manage-monitor-eventhouse.md#view-system-overview-details-for-an-event-house) opens in the main view area of the newly created eventhouse.
