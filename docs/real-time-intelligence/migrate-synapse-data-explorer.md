...
The Microsoft Cloud Migration Factory (CMF) program accepts customer nominations from the Microsoft account team, to help customers migrate to Fabric. CMF provides hands-on keyboard resources at no-cost to the customer. Hands-On keyboard resources are assigned for 6-8 weeks with an agreed scope. Customers can also use [this form](https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR0PMD-G9mq1Kry22u32eGOtUQ1pWQVIyUU9USDBXSjUwQ1E0NEJCMExORC4u) to request help directly from the CMF team.
