...
1. Select the data source from the available list. In this example, you're ingesting data from **Amazon S3**.
    ...
    :::image type="content" source="media/get-data-amazon-s3/get-data-a3-tile.png" alt-text="Screenshot of the get data tiles with the Amazon S3 option highlighted.":::
