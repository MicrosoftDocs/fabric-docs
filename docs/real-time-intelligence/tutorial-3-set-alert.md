...
In this part of the tutorial, you set an Activator alert on your eventstream to receive a notification in Teams when the number of bikes at bike station decreases to zero.
...
1. In the **Add rule** page, follow these steps:
    ...
    1. In the **Details** section, for **Rule name**, enter **No bikes available at bike station**.
