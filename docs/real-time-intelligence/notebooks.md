...
* [Analyze data in a KQL Database with Lakehouse or Warehouse](analyze-data-with.md) with a new or existing notebook.
...
* [Analyze data in a KQL Database with Lakehouse or Warehouse](analyze-data-with.md)
