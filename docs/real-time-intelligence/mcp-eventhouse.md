...
Get started using the detailed instructions in [Get started with the Eventhouse remote MCP server (Preview)](mcp-eventhouse-remote-get-started.md). The main steps are:
