---
title: Live Refresh in Real-Time Dashboard
...
# Live refresh in Real-Time Dashboard
...
1. Choose between the following options: 
    ...
    :::image type="content" source="media/dashboard-live-refresh/live-refresh-settings.png" alt-text="Screenshot of the Live refresh settings pane.":::
...
:::image type="content" source="media/dashboard-live-refresh/visual-refresh.png" alt-text="Screenshot of a visual's last refreshed timestamp.":::

## Pause or resume updates 

If you're investigating a specific data point and don't want the visuals to change, in the dashboard ribbon switch to **Viewing** mode and select the **Live refresh** button to turn live refresh **Off** (Paused). While paused, the dashboard doesn't perform any automated refreshes. Toggle it back to **On** to resume live refreshing. 

:::image type="content" source="media/dashboard-live-refresh/enable-live-refresh.png" alt-text="Screenshot of the Live refresh button in the dashboard ribbon.":::
...
* [Real-Time Dashboards Overview](overview.md)
