...
1. Retrieve the **Search ID** and **render configuration** parameters. For detailed instructions, see [Get the WMTS endpoint URL from the MPC Pro geocatalog](get-mpc-pro-wmts-endpoint.md).
