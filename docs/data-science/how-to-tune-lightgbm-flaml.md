...
* Create a new [Fabric environment](../data-engineering/create-and-use-environment.md) or ensure you are running on the Fabric Runtime 1.2 (Spark 3.4 and Delta 2.4)
...
import mlflow
mlflow.set_experiment("flaml_tune_housing")
...
# Get the best metric value from the analysis object
flaml_metric = analysis.best_metric
# Print the best metric value
print("Best metric: ", flaml_metric)
...
```python
# Train a new model with the best hyperparameters on the full training dataset
...
- [Visualize results](./data-science/tuning-automl-visualizations.md)
