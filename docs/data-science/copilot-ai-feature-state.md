...
| **Data Factory** | Dataflows gen2 | - [Generate a new query](../data-factory/copilot-fabric-data-factory.md#get-started-with-copilot-for-dataflow-gen2). |
| | Data pipeline | - [Generate and run a data pipeline](../data-factory/copilot-fabric-data-factory.md#generate-a-data-pipeline-with-copilot).<br />- [Summarize a data pipeline](../data-factory/copilot-fabric-data-factory.md#summarize-a-data-pipeline-with-copilot).<br />- [Troubleshoot pipeline errors](../data-factory/copilot-fabric-data-factory.md#troubleshoot-pipeline-errors-with-copilot). |
