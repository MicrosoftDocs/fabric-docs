...
- Enable [cross-geo processing and cross-geo storing for AI](../data-agent-tenant-settings.md) based on requirements explained in [Fabric data agent tenant settings](../data-agent-tenant-settings.md).
