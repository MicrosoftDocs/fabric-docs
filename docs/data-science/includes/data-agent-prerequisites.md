...
- [Fabric data agent tenant settings](../data-agent-tenant-settings.md) is enabled, including the **Capacities can be designated as Fabric Copilot capacities** setting.
