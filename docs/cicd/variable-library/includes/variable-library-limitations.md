...
* There is one and only one active value set in a workspace at a time. You can't delete the active value set. To delete it, first set another value set to be active.
