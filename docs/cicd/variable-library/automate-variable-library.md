...
To automate the management of variable libraries in application lifecycle management (ALM), use the [Fabric REST APIs](/rest/api/fabric/articles/get-started/using-fabric-apis).  
