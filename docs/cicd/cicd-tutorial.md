...
Let's connect this workspace to the main branch of your Azure repo so all team members can edit it and create pull requests. If you're using a GitHub repo, follow the directions in [Connect a workspace to a GitHub repo](./git-integration/git-get-started.md#github-connect).
