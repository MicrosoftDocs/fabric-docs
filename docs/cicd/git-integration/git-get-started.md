...
1. Select the **Changes** tab of the **Source control** panel.
...
1. Select the **Updates** tab of the **Source control** panel. A list appears with all the items that were changed in the branch since the last update.
1. Select **Update all**.
