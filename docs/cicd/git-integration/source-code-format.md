...
- `description`: (optional string) Description of the item.
 ...
 If you rename the item in the workspace and the item folder in Git has a '.' suffix, then after committing, the `displayName` and directory name in Git will match.
