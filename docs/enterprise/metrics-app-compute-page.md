---
title: Capacity Metrics app compute page
description: Learn how to read the Microsoft Fabric Capacity Metrics app compute page to monitor capacity utilization, throttling, overages, and per-item usage.
...
# Compute page in the Fabric Capacity Metrics app
...
:::image type="content" source="media/fabric-cross-filter-overages.gif" alt-text="Animation that shows the Overages tab cross-filtering carryforward overage data over time." lightbox="media/fabric-cross-filter-overages.gif":::
...
After you select a column in the chart, you can use the *Explore* buttons to drill through to the [timepoint summary](metrics-app-timepoint-summary-page.md) or [timepoint detail](metrics-app-timepoint-page.md) pages.

Filters you apply to the page in the [Multimetric ribbon chart](#multimetric-ribbon-chart) affect the Timepoint and Cumulative visuals as follows:
...
|Virtualized item      |Displays one of the following values:<ul><li>*True* - Virtual items that consume CUs, such as virtual items used by Copilot</li><li>*False* - Items that aren't virtual</li></ul> |
|Virtualized workspace |Displays one of the following values:<ul><li>*True* - Virtual workspaces that consume CUs, such as a virtual workspace used by a virtual network</li><li>*False* - Workspaces that aren't virtual</li></ul> |
...
* [Eventhouse and KQL database consumption](../real-time-intelligence/real-time-intelligence-consumption.md)
