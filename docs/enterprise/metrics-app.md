...
- Data for new capacities is not visible in the Metrics app until the next scheduled refresh. Data for new items and workspaces is not visible until the next scheduled refresh after their first operation consuming capacity units within the past 14 days. To view the data before the next scheduled refresh, initiate a manual refresh of the semantic model.
