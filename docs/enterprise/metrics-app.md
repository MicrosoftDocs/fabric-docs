...
- The Microsoft Fabric Capacity Metrics app doesn't support alerts or notifications. To set up alerts on your capacity health, use Fabric capacity overview events. For more information, see [Explore Fabric capacity overview events](../real-time-hub/explore-fabric-capacity-overview-events.md).
