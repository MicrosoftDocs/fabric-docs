...
| Operation          | Description                                                                                        | Item      | Azure billing meter | Type       |
| ------------------ | -------------------------------------------------------------------------------------------------- | --------- | ------------------- | ---------- |
| User Data Functions Execution    | Compute charge for the execution of the function inside of the User Data Functions item. This operation results from testing a function in Develop mode or running a function in Run only mode.  | User Data Functions | User Data Function Execution (CU/s)  | Interactive |
