...
| **Health** | Shows different states according to its usage behavior:<br><ul><li><strong>Healthy</strong> – Capacity is not experiencing any throttling.</li><li><strong>Suspended</strong> – Capacity is suspended.</li><li><strong>At Risk of Throttling</strong> – Capacities that have at least one 30 sec. window where 10-min interactive % was above 90% and capacity overage is not enabled.</li><li><strong>At Risk of Overage Billing</strong> – Capacities that have at least one 30 sec. window where 10-min interactive % was above 90% and capacity overage is enabled.</li><li><strong>Overage Billing Active</strong> – Capacities that have at least one 30 sec. window where 10-min interactive % was above 100% and capacity overage is enabled.</li><li><strong>Throttling</strong> – Capacities that have at least one 30 sec. window where 10-min interactive % was above 100% and thus may have operations that were throttled.</li><li><strong>At Risk of Interactive Rejection</strong> – Capacities that have at least one 30 sec. window where 60-min interactive % was above 90%.</li><li><strong>Interactive Rejection</strong> – Capacities that have at least one 30 sec. window where 60-min interactive % was above 100%.</li><li><strong>At Risk of Background Rejection</strong> – Capacities that have at least one 30 sec. window where 24 hour background % was above 90%.</li><li><strong>Background Rejection</strong> – Capacities that have at least one 30 sec. window where 24 hour background % was above 100%.</li></ul> |
