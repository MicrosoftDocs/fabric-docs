...
To access the admin portal you need a [Fabric license](../enterprise/licenses.md#individual-licenses). The admin portal can be accessed by admins with the following roles:
