...
| **[Workspace settings](/power-bi/admin/service-admin-portal-workspace)** |  |
...
| **[Information protection](/power-bi/admin/service-admin-portal-information-protection)** |  |
...
| **[Export and sharing settings](/power-bi/admin/service-admin-portal-export-sharing)** |  |
...
| **[Discovery settings](/power-bi/admin/service-admin-portal-discovery)** |  |
...
| **[Content pack and app settings](/power-bi/admin/service-admin-portal-content-pack-app)** |  |
...
| **[Integration settings](/power-bi/admin/service-admin-portal-integration)** |  |
...
| **[Power BI visuals](/power-bi/admin/service-admin-portal-power-bi-visuals)** |  |
...
| **[R and Python visuals settings](/power-bi/admin/service-admin-portal-r-python-visuals)** |  |
...
| **[Audit and usage settings](/power-bi/admin/service-admin-portal-audit-usage)** |  |
...
| **[Dashboard settings](/power-bi/admin/service-admin-portal-dashboard)** |  |
...
| **[Developer settings](/power-bi/admin/service-admin-portal-developer)** |  |
...
| **[Admin API settings](/power-bi/admin/service-admin-portal-admin-api-settings)** |  |
...
| **[Q&amp;A settings](/power-bi/admin/service-admin-portal-qa)** |  |
...
| **[Datamart settings](/power-bi/admin/service-admin-portal-datamart)** |  |
| Create Datamarts (Preview) | Users in the organization can create Datamarts |
| **[Data model settings](/power-bi/admin/service-admin-portal-data-model)** |  |
...
| **[Quick measure suggestions](/power-bi/admin/service-admin-portal-quick-measure-suggestions-settings)** |  |
...
| **[Scale-out settings](/power-bi/admin/service-admin-portal-scale-out)** |  |
