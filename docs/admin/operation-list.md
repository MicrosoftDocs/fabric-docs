...
| Exported a PostgreSQL database schema | :::no-loc text="PgSchemaExported"::: | Generated when a user dumps a PostgreSQL database schema through the custom PG schema service (pgschema-based ALM flow). The audit log records caller identity, operation result, and the affected PostgreSQL database artifact. |
...
| Imported PostgreSQL sample data | :::no-loc text="ImportedSampleData"::: | Generated when a user imports supported sample data into a Fabric Native PostgreSQL database. The audit log records caller identity, operation result, and the affected PostgreSQL database artifact. |
...
| Retrieved PostgreSQL SQL audit policy | :::no-loc text="SqlAuditPolicyRetrieved"::: | Generated when a user retrieves the SQL audit policy settings for a PostgreSQL database artifact. The audit log records caller identity, operation result, and the affected PostgreSQL database artifact. |
...
| Set PostgreSQL SQL audit policy | :::no-loc text="SqlAuditPolicySet"::: | Generated when a user updates SQL audit policy settings for a PostgreSQL database artifact. The audit log records caller identity, operation result, and the affected PostgreSQL database artifact. |
