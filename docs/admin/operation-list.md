...
| Requested Power BI dataflow refresh | RequestDataflowRefresh | Triggered when a dataflow refresh starts. The refresh can be scheduled or triggered manually from the portal or an API.  |
