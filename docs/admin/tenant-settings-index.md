...
|[Users can discover and create org apps (preview)](/power-bi/consumer/org-app-items/org-app-items)|Users in your organization can create org apps as items when this setting is turned on. Users with access can view them. By turning on this setting, you agree to the  [Preview Terms](https://aka.ms/orgapps_previewterms).<br><br>When turned off, users can't create new org apps. Existing org apps can still be viewed and edited. The prior version of workspace apps will still be available.  [Learn More](https://aka.ms/orgapps_learnmore)|
...
|[Private link paths for Iceberg virtualization (preview)](../onelake/onelake-iceberg-tables.md#virtualize-delta-lake-tables-as-iceberg)|For Delta Lake to Iceberg virtualization, use workspace private link paths instead of global OneLake paths in generated metadata files.<br><br>Note: This setting controls a feature that is currently in preview. This setting will be removed in a future update when the feature is no longer in preview.|
