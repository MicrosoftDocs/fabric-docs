...
|[Fabric item recovery](item-recovery.md#set-up-the-retention-period-for-deleted-items)|Once item recovery is enabled, deleted items are retained for a minimum of 7 days. You can specify a longer retention period for a maximum of 90 days. At the end of the retention period, the items are permanently deleted.<br>If you leave this setting turned off, deleting items will be a permanent action.<br>Turn on this setting to enable the deleted items to be retained for a defined period. Provide the number of days to retain items before they're permanently deleted.|
