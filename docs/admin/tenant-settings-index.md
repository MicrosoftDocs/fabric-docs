...
|[Digital Twin Builder (preview)](../real-time-intelligence/digital-twin-builder/overview.md)​|Users can create digital twin builder items to build comprehensive digital twins of real world environments and processes, to enable big-picture data analysis and drive operational efficiency. [Learn More](https://aka.ms/digital-twin-builder-overview)|
