...
|Users can create Digital Twin Builder (preview) items|Users can create digital twin builder items to build comprehensive digital twins of real world environments and processes, to enable big-picture data analysis and drive operational efficiency.|
