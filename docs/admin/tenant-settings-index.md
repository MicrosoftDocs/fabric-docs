...
|[Enable Ontology item (preview)](/fabric/iq/ontology/overview)|Users can create ontologies to unify enterprise semantics across data, models and logic to operationalize decision intelligence with context-aware AI agents.|
...
|Users can use Azure Maps Weather Services (Preview)|When this setting is enabled, users can access weather data from Azure Maps Weather, sourced from AccuWeather  [Learn More](https://go.microsoft.com/fwlink/?linkid=2289253)|
