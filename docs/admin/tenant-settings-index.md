...
|Users can send email subscriptions to guest users|Users can send email subscriptions to guest users. With this setting off, users in your organization can't subscribe guest users to subscription emails.  [Learn More](https://go.microsoft.com/fwlink/?linkid=2256884)|
