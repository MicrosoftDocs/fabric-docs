...
|Detect anomalies in Real-Time Hub|This setting allows users to create AI-recommended models to detect anomalies on real-time data and take automatic action on anomalies.  [Learn More](https://aka.ms/AD_docs)|
|Users can create Maps (preview)|Users can build map items to analyze live geospatial data with interactive, real-time visualizations, helping uncover location-based insights.  [Learn More](../real-time-intelligence/map/create-map.md)|
