...
|Allow custom visuals to get user Azure Active Directory access tokens|Enabling this setting will allow custom visuals to obtain Azure Active Directory access tokens of signed-in users.  [Learn More](https://go.microsoft.com/fwlink/?linkid=2236555)|
