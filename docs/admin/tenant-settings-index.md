...
|[Users can send email subcriptions to guest users](service-admin-portal-export-sharing#users-can-send-email-subscriptions-to-external-users)|Users can send email subscriptions to guest users. With this setting off, users in your organization can't subscribe guest users to subscription emails.  [Learn more](https://go.microsoft.com/fwlink/?linkid=2256884)|
