...
|[Guest users can access Microsoft Fabric](/power-bi/enterprise/service-admin-entra-b2b)|Guest users who've been added to your Microsoft Entra directory can access Microsoft Fabric and any Fabric items they have permissions to.  [Learn More](https://go.microsoft.com/fwlink/?linkid=2257019)|
...
|[Guest users can browse and access Fabric content](/power-bi/enterprise/service-admin-entra-b2b)|Users can invite guest users to browse and request access to Fabric content.  [Learn More](https://go.microsoft.com/fwlink/?linkid=2038485)|
