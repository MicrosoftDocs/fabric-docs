...
|Enable Ontology item (preview)|Users can create ontologies to unify enterprise semantics across data, models and logic to operationalize decision intelligence with context-aware AI agents. [Learn More](/fabric/iq/ontology/overview)|
