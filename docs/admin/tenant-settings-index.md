...
|Enable Denodo SSO|Enable SSO capability for Denodo. By enabling, user access token information, including name and email, will be sent to Denodo for authentication.|
|Enable Starburst SSO|Enable SSO capability for Starburst. By enabling, user access token information, including name and email, will be sent to Starburst for authentication.|
