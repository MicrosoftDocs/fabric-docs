...
|Enable Fabric App Items (preview)|Users can create Fabric apps which is a Fabric\x{2011}native suite of services for building intelligent applications for front end and backend of your application. It allows developers and AI agents to create and operate complete app backends directly on Microsoft Fabric. Fabric Apps unifies operational data, analytics, and AI while meeting enterprise security and governance requirements. [Learn More](https://go.microsoft.com/fwlink/?linkid=2353418)|
