...
|Sustainability solutions (preview)|Turn on this setting to give your tenant users the permission to deploy the Sustainability solutions (preview) and its associated capabilities.  [Learn more](https://aka.ms/learn-about-sustainability-solutions)|
