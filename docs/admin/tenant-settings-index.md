...
|Users can create a Planning (preview) item(s)|Users can create a Plan in Fabric and leverage no-code integrated planning using Power BI Semantic models, Fabric SQL and OneLake.  [Learn More](https://aka.ms/planningdocs)|
