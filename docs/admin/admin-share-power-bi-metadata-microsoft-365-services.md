...
- **[Frontier only] Asking Microsoft 365 Copilot about Power BI data:** Microsoft 365 Copilot can answer questions using Power BI reports and semantic models that the user has permission to view, regardless of this setting. Access to this feature requires Microsoft 365 admin approval. For more information, see [Fabric IQ in Microsoft 365 Copilot (Frontier)](/fabric/iq/connectors/m365-copilot-overview).
