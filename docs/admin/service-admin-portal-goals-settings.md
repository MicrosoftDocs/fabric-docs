---
title: Scorecards admin settings
description: Learn how to configure Scorecards admin settings in Fabric.
author: msmimart
ms.author: mimart
ms.custom:
  - tenant-setting
...
# Scorecards tenant settings 

These settings are configured in the tenant settings section of the Admin portal. For information about how to get to and use tenant settings, see [About tenant settings](tenant-settings-index.md).

## Create and use scorecards

Users in the organization can create and use scorecards in Power BI.
