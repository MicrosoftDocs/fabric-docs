...
1. Move the mouse over **Job events**, and do one of the following steps:
    ...
    - Select **ellipsis (...)**, and select **Set alert**.
        ...
        :::image type="content" source="./media/set-alerts-fabric-job-events/fabric-jobs.png" alt-text="Screenshot that shows the Fabric events list page." lightbox="./media/set-alerts-fabric-job-events/fabric-jobs.png":::
