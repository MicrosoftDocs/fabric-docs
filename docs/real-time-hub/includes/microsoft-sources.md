...
| Azure Event Grid Namespace | A fully managed event routing service. | [Learn more](../add-source-azure-event-grid.md) |
| Azure Event Hubs Namespace | A fully managed real-time data ingestion service. | [Learn more](../add-source-azure-event-hubs.md) |
| Azure IoT Hub | A platform for managing IoT devices and data. | [Learn more](../add-source-azure-iot-hub.md) |  
| Azure MySQL Database (CDC) | Stream changes from Azure MySQL databases. | [Learn more](../add-source-mysql-database-cdc.md) |
...
| PostgreSQL CDC | Stream changes from PostgreSQL databases. | [Learn more](../add-source-postgresql-database-cdc.md) |
