...
| Create real-time dashboard (Preview) |[Create a Real-Time Dashboard with Copilot](../real-time-intelligence/copilot-generate-dashboard.md) based on data in the KQL table. |
