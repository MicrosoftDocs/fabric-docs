...
* You can enable CMK by using the Fabric portal or APIs. Workspace administrators can use APIs Assign Workspace Encryption, Get Workspace Encryption and Reset Workspace Encryption to turn CMK setting on/off and view the CMK status of the workspace. Tenant administrators can use List Workspaces API to get the encryption status of all the workspaces in their tenant.
