...
* If your organization has an Entra Conditional access policy for workload identities that includes all service principals, then trusted workspace access will not work. In such instances, you will need to exclude specific Fabric workspace identities from the Conditional access policy for workload identities.
