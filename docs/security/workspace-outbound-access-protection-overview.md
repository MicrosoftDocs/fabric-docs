...
| Real-Time Intelligence | Data connection rules | <ul><li>Eventhouses</li></ul> | [Workspace outbound access protection for Real-Time Intelligence](workspace-outbound-access-protection-real-time-intelligence.md) |
