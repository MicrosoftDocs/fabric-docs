...
| Activator (preview) | Data connection rules | <ul><li>Activator</li></ul> | [Workspace outbound access protection for Activator (preview)](workspace-outbound-access-protection-activator.md) |
