...
| Fabric IQ | Data connection rules | <ul><li>Graph model</li><li>Graph queryset</li></ul> | [Workspace outbound access protection for Fabric IQ](workspace-outbound-access-protection-iq.md) |
