...
* [Azure IP Ranges and Service Tags – Public Cloud](https://www.microsoft.com/download/details.aspx?id=56519) — You can refer to the `PowerBI` tag. Microsoft Fabric currently does not support regional service tags nor breakdown IP ranges by region.
