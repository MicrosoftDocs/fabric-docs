...
You can publish semantic models to a protected workspace through any of the standard deployment paths:

- **Power BI Desktop**: Publish a `.pbix` file directly. When the file includes an interactive report, the report is published alongside the model and queries to it in the protected workspace. See [Workspace outbound access protection for Power BI reports](workspace-outbound-access-protection-power-bi-reports.md).
...
- **Interactive reports are supported; other Power BI items aren't**: Interactive Power BI reports (`.pbix`) can coexist with semantic models in a protected workspace and can be published directly. Paginated reports, dashboards, and scorecards aren't supported. See [Workspace outbound access protection for Power BI reports](workspace-outbound-access-protection-power-bi-reports.md).
