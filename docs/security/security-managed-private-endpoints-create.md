...
1. Specify a name for the private endpoint and copy in the resource identifier for the Azure resource. The resource identifier can be found in the properties tab on the Azure portal page. For more infomation see: [How to get your Azure Resource ID](/azure/communication-services/quickstarts/voice-video-calling/get-resource-id.md)
