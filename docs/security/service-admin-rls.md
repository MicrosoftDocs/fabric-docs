...
[!INCLUDE [include-short-name](/power-bi/includes/rls-desktop-define-roles)]
...
[!INCLUDE [include-short-name](/power-bi/includes/rls-desktop-view-as-roles)]
...
[!INCLUDE [include-short-name](/power-bi/includes/rls-usernames)]
...
[!INCLUDE [include-short-name](/power-bi/includes/rls-limitations)]

[!INCLUDE [include-short-name](/power-bi/includes/rls-faq)]
