...
- **Connect to Fabric data sources**
  - **SQL analytics endpoints**: Lakehouses and warehouses expose [SQL connection strings](../data-warehouse/how-to-connect.md) so you can query data from standard SQL tools.
