...
| **SQL database** | SQL queries in SQL database | - [Generate SQL queries](../database/sql/copilot-chat-pane.md).<br />- [Suggest SQL code completions](../database/sql/copilot-code-completion.md).<br />- [Fix code in SQL queries](../database/sql/copilot-quick-actions.md).<br />- [Explain code in SQL queries(preview)] (../database/sql/copilot-quick-actions.md). | GA |
