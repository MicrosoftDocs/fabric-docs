...
[Microsoft Copilot for Power BI](/power-bi/create-reports/copilot-introduction) uses generative AI to help you analyze data and create reports. Before you start using Copilot, you might have questions about how it handles your business data, what information it accesses in your semantic models, and how to use generative AI responsibly.

This article explains what data Copilot for Power BI accesses, how your data stays secure, and how to evaluate Copilot outputs for accuracy and responsible use. For the overall Fabric privacy and security model, see [Privacy, security, and responsible use for Copilot in Microsoft Fabric](copilot-privacy-security.md).
...
- To answer data questions from the semantic model, Copilot requires that the Power BI Q&A natural language feature be enabled in the semantic model's dataset settings. For more information, see [Update your data model to work well with Copilot for Power BI](/power-bi/create-reports/copilot-evaluate-data).
...
For more tips, see [FAQ for Copilot for Power BI](copilot-faq-fabric.yml).

## Data privacy and security in Copilot for Power BI
...
## Responsible AI evaluation of Copilot for Power BI

Copilot for Power BI is evaluated against Microsoft's responsible AI principles. Harm mitigation measures include:

- **Content filtering:** Copilot's output is scoped to Power BI reporting and data analysis topics. Off-topic or harmful requests are blocked.
- **Grounded responses:** Copilot generates responses based on the data in your semantic model, reducing the risk of hallucinated information.
- **Human oversight:** All Copilot-generated visuals, DAX queries, and summaries are presented as suggestions for you to review before applying.
