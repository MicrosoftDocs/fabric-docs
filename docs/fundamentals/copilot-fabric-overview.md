...
| **AI for Data Science** | Data agent <br> AI functions <br> AI services | - [Create Data agent](../data-science/how-to-create-data-agent.md). <br />- [AI functions](../data-science/ai-functions/overview.md).<br />- [AI services](../data-science/ai-services/ai-services-overview.md#ai-services-in-fabric-preview).<br />
