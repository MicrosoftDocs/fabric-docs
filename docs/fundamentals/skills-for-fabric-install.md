...
- **[Power BI Desktop](https://powerbi.microsoft.com/desktop/)** (recommended) for opening and validating PBIX or PBIP projects locally.
...
| Plugin update not reflected | Cached plugin version is still active. | Restart Copilot CLI. If still stale, uninstall and reinstall the plugin as shown in [Update skills](#update-skills). |
