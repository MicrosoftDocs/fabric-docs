...
- Easily ingests data from many different sources and converts it into a unified Delta format.
...
- Automatically provides a SQL analytics endpoint that allows T-SQL querying of delta tables in the lake.
