...
1. Select **Create** from the left navigation bar, select **OneLake catalog**, and choose a [supported Fabric data source](direct-lake-overview.md#supported-fabric-data-sources). Alternatively, open a supported source item and select **New semantic model**.
