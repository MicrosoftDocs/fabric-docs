...
:::image type="content" source="./media/analyze-and-train-data/analyze-agents.png" alt-text="Screenshot of AI Agents architecture diagram.":::
...
:::image type="content" source="./media/analyze-and-train-data/analyze-data-science.png" alt-text="Screenshot of Data Science workflows diagram.":::
