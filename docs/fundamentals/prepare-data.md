...
:::image type="content" source="./media/prepare-data/prepare-notebook-function.png" alt-text="Screenshot of Notebooks and User Data Functions for data preparation.":::
