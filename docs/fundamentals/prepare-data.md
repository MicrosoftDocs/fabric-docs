...
:::image type="content" source="./media/Prepare-DataflowGen2.png" alt-text="Screenshot of Dataflow Gen2 data preparation interface.":::
...
:::image type="content" source="./media/Prepare-NotebookFunction.png" alt-text="Screenshot of Notebooks and User Data Functions for data preparation.":::
