...
:::image type="content" source="./media/data-lifecycle/fabric-data-lifecycle.png" alt-text="Screenshot showing the end-to-end data lifecycle in Microsoft Fabric." lightbox = "./media/data-lifecycle/fabric-data-lifecycle.png" :::
