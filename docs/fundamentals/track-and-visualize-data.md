...
:::image type="content" source="./media/Track-PowerBI-Translytical.png" alt-text="Screenshot of Power BI translytical taskflows diagram.":::
...
:::image type="content" source="./media/Track-RTI.png" alt-text="Screenshot of Real-Time Intelligence architecture diagram.":::
