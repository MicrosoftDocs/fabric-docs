---
title: GQL status codes reference for Fabric Graph
description: Review the complete reference of GQL status codes returned by Fabric Graph queries, including success, warning, and error condition codes with descriptions.
ms.topic: reference
ms.date: 03/02/2026
...
When you run GQL queries in Microsoft Fabric, you receive status information along with your results. This article lists all GQLSTATUS codes used by Fabric Graph.
