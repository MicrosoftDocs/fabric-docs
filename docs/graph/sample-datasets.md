...
Most documentation articles for Fabric Graph assume one of the following example [property graphs](graph-data-models.md) when they provide GQL queries:
...
The [Fabric Graph samples repository](https://github.com/microsoft/fabric-samples/blob/main/docs-samples/graph) publishes the required datasets for these graphs.
