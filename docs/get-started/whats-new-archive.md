...
|**Month** | **Feature** |  **Learn more**|
|:-- |:-- | :-- |
|October 2023|**From RabbitMQ to PowerBI reports with Microsoft Fabric Real-Time Intelligence**|A walkthrough of an [end-to-end scenario sending data from RabbitMQ to a KQL Database in Microsoft Fabric](https://blog.fabric.microsoft.com/blog/from-rabbitmq-to-powerbi-reports-with-microsoft-fabric-real-time-analytics?ft=All).|
