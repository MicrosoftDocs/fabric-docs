...
<a name=eventhouse></a>
> [!NOTE]
> Eventhouse is a workspace for multiple KQL databases. KQL databases are generally available, while Eventhouse is currently in public preview. For more information, see [Eventhouse overview (preview)](../real-time-analytics/eventhouse.md).
