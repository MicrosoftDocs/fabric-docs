...
<sup>2</sup> Viewers can be granted granular SQL permissions to read Lakehouse and Data warehouse data through SQL endpoints by Admins, Members, and Contributors.
