...
|-----------|-------------------------|----------------------------------|----------------------|------------------|
|  532 | Power BI | [Sign in fails for securely embedded reports using Chrome or Microsoft Edge browser](known-issues/known-issue-532-sign-in-fails-securely-embedded-reports-using-chrome-browser.md)    | February 14, 2024 |
