...
|[Data Factory](../data-factory/tutorial-end-to-end-introduction.md) | In this tutorial, you'll create a complete data integration scenario using a pipeline and dataflow gen2. |
