...
Microsoft Fabric brings together workloads such as Data Engineering, Data Factory, Data Science, Data Warehouse, Real-time Analytics, and Power BI onto a shared SaaS foundation. This integration provides the following advantages:
...
- **Data Warehouse** - Data Warehouse workload provides industry leading SQL performance and scale. It fully separates compute from storage, enabling independent scaling of both the components. Additionally, it natively stores data in the open Delta Lake format.
...
All the Microsoft Fabric compute workloads are prewired to OneLake, just like the Office applications are prewired to use the organizational OneDrive. The Microsoft Fabric’s workloads such as Data Engineering, Data Warehouse, Data Factory, Power BI, and Real-time Analytics use OneLake as their native store. They don't need any extra configuration.
