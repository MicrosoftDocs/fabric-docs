...
- **Fabric [!INCLUDE [fabric-activator](../includes/fabric-activator.md)]** - [!INCLUDE [fabric-activator](../includes/fabric-activator.md)] is a no-code experience in Fabric that allows you to specify actions, such as email notifications and Power Automate workflows, to launch when [!INCLUDE [fabric-activator](../includes/fabric-activator.md)] detects specific patterns or conditions in your changing data. It monitors data in Power BI reports and eventstreams; when the data hits certain thresholds or matches other patterns, it automatically takes the appropriate action. For more information, see [What is Fabric [!INCLUDE [fabric-activator](../includes/fabric-activator.md)]?](../real-time-intelligence/data-activator/data-activator-introduction.md)
