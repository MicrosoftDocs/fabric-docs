...
|**Month** | **Feature** |  **Learn more**|
|:-- |:-- | :-- |
|October 2023|**Get started with semantic link (public preview) in Microsoft Fabric**|Explore how semantic link seamlessly connects Power BI datasets with Synapse Data Science within Microsoft Fabric. Learn more at [Semantic link: use Fabric notebooks and Power BI datasets for machine learning, data validation and more!](http://blog.fabric.microsoft.com/blog/semantic-link-in-microsoft-fabric-bridging-bi-and-data-science/). |
