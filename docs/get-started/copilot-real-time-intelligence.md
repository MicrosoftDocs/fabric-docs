...
> [!NOTE]
> The Submit feedback form submits the name of the database, its url, the kql query generated by copilot, and any freetext response you include in the feedback submission. Results of the executed kql query aren't sent.
