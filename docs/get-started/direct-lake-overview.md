...
- Automation is only supported with [service principal](/power-bi/developer/embedded/embed-service-principal) authentication.
...
| Power BI Embedded | Yes <sup>1</sup> | Yes | Yes |
