...
|---------|---------|---------|---------|
|:::image type="content" source="./media/onelake-data-hub/datahub-icon-1.png" alt-text="Screenshot of data hub icon alternate 1.":::     ||:::image type="content" source="./media/onelake-data-hub/datahub-icon-2.png" alt-text="Screenshot of data hub icon alternate 2.":::||:::image type="content" source="./media/onelake-data-hub/datahub-icon-3.png" alt-text="Screenshot of data hub icon alternate 3.":::||:::image type="content" source="./media/onelake-data-hub/datahub-icon-4.png" alt-text="Screenshot of data hub icon alternate 4.":::|
