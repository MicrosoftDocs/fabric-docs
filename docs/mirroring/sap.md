...
Each mirrored SAP database has an autogenerated **SQL analytics endpoint** that provides a read-only analytical experience on top of the Delta tables created by the mirroring process. You can browse mirrored tables, build no-code queries and views, create SQL views and stored procedures, and query data across warehouses and lakehouses in the same workspace.
