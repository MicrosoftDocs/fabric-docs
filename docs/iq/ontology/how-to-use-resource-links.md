...
Linked resources can be displayed in a tile on the **Overview** tab of the entity type details. An entity type can only have one **Resource links** tile at a time.
