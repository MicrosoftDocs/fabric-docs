---
title: "Tutorial: Create an operations agent to use with ontology"
description: Create an operations agent that monitors an ontology (preview) item by using business rules in natural language. Part 5 of the ontology (preview) tutorial.
ms.date: 04/28/2026
ms.topic: tutorial
---

# Ontology (preview) tutorial part 5: Create operations agent
...
Follow these steps to create a new operations agent that monitors your ontology (preview) item. For full details on each setup field, see [Create an operations agent](../../real-time-intelligence/operations-agent.md#create-an-operations-agent).

1. In your Fabric workspace, select **+ New item**. Create a new **Operations agent (preview)** item named *RetailOntologyOpsAgent*.
...
Next, continue to the [tutorial conclusion](tutorial-6-conclusion.md).
