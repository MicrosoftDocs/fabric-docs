...
| Generating entity type bindings to data sources | Not supported | Supported as long as the backing lakehouse is in a workspace with **inbound public access enabled** | Not Supported |
