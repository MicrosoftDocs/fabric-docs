---
title: Configure Rules Using Format by Classification in Conditional Formatting
description: Learn how to use classification-based conditional formatting in planning sheets.
ms.date: 05/15/2026
ms.topic: how-to
#customer intent: As a user, I want to understand and use classification-based conditional formatting in planning sheets.
---

# Configure rules using format by classification

When creating conditional formatting rules, you can choose from three **Format by** options that determine how formatting is applied. This article explains the **Classification** format option in detail.
...
## Enable format by classification
...
* **Display**: Select the display icons from **Text, Rating** or **Icon Set** to categorize values.
     ...
     :::image type="content" source="../media/planning-conditional-formatting/how-to-format-classification/display-options.png" alt-text="Screenshot of display options." lightbox="../media/planning-conditional-formatting/how-to-format-classification/display-options.png":::
...
* **Classification ranges -** Use **Classification ranges** to define color ranges and icons based on **values** or **percentages**. You can add or remove ranges as needed.
     ...
     :::image type="content" source="../media/planning-conditional-formatting/how-to-format-classification/classification-range.png" alt-text="Screenshot of classification range.":::

After configuring the settings, save the rule to apply classification formatting to the selected cells.

:::image type="content" source="../media/planning-conditional-formatting/how-to-format-classification/classification-configured.jpg" alt-text="Screenshot of classification being configured." lightbox="../media/planning-conditional-formatting/how-to-format-classification/classification-configured.jpg":::
