...
:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-select-measure.png" alt-text="Screenshot of selecting a measure in Bulk Edit." lightbox="media/planning-how-to-bulk-edit/bulk-edit-select-measure.png":::
...
:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-select-apply-to-row-level.png" alt-text="Screenshot of the Apply to Row Level option in Bulk Edit." lightbox="media/planning-how-to-bulk-edit/bulk-edit-select-apply-to-row-level.png":::
...
:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-select-type.png" alt-text="Screenshot of update type options in Bulk Edit." lightbox="media/planning-how-to-bulk-edit/bulk-edit-select-type.png":::

## Distribute values

1. Select a **Distribution** method for child rows. Distribute updated values equally or based on another measure's weights.

    :::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-select-distribution.png" alt-text="Screenshot of distribution options for child rows in Bulk Edit." lightbox="media/planning-how-to-bulk-edit/bulk-edit-select-distribution.png":::
...
:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-text-inputs.png" alt-text="Screenshot of applying text values with Bulk Edit." lightbox="media/planning-how-to-bulk-edit/bulk-edit-text-inputs.png":::

The text column is updated with the selected value.

:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-text-inputs-result.png" alt-text="Screenshot of text values updated across selected rows." lightbox="media/planning-how-to-bulk-edit/bulk-edit-text-inputs-result.png":::

### Bulk edit date inputs

Use **Bulk Edit** to apply date values across selected categories and subcategories.

:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-date.png" alt-text="Screenshot of applying date values with Bulk Edit." lightbox="media/planning-how-to-bulk-edit/bulk-edit-date.png":::

The date column is updated with the selected date.

:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-date-result.png" alt-text="Screenshot of updated date values across selected rows." lightbox="media/planning-how-to-bulk-edit/bulk-edit-date-result.png":::
...
:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-add-duration.png" alt-text="Screenshot of the Add Duration option for date values in Bulk Edit." lightbox="media/planning-how-to-bulk-edit/bulk-edit-add-duration.png":::

Date values are recalculated based on the selected duration.

:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-add-duration-result.png" alt-text="Screenshot of date values updated after applying a duration." lightbox="media/planning-how-to-bulk-edit/bulk-edit-add-duration-result.png":::

### Bulk edit person inputs

Use **Bulk Edit** to assign person values across selected categories and subcategories.

:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-person.png" alt-text="Screenshot of assigning person values with Bulk Edit." lightbox="media/planning-how-to-bulk-edit/bulk-edit-person.png":::

The person column is updated with the selected user value.

:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-person-result.png" alt-text="Screenshot of assigned person values across selected rows." lightbox="media/planning-how-to-bulk-edit/bulk-edit-person-result.png":::
...
:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-single-select.png" alt-text="Screenshot of applying a single-select dropdown value with Bulk Edit." lightbox="media/planning-how-to-bulk-edit/bulk-edit-single-select.png":::

The single-select column is updated with the selected dropdown value.

:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-single-select-result.png" alt-text="Screenshot of updated single-select values across selected rows." lightbox="media/planning-how-to-bulk-edit/bulk-edit-single-select-result.png":::
...
:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-multi-select.png" alt-text="Screenshot of applying multi-select dropdown values with Bulk Edit." lightbox="media/planning-how-to-bulk-edit/bulk-edit-multi-select.png":::

The multi-select column is updated with the selected dropdown values.

:::image type="content" source="media/planning-how-to-bulk-edit/bulk-edit-multi-select-result.png" alt-text="Screenshot of updated multi-select values across selected rows." lightbox="media/planning-how-to-bulk-edit/bulk-edit-multi-select-result.png":::
