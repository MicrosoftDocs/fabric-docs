...
# Configure rules using Format by Color scale in conditional formatting

When creating conditional formatting rules, you can choose from three **Format by** options that determine how formatting is applied. This article explains the Color scale format option in detail. Refer to [create rules in conditional formatting]((planning-how-to-create-rules-conditional-formatting.md) to know about it.
...
* **Action Color** - Applies color-based formatting to action or status indicators.
     ...
     :::image type="content" source="media/planning-how-to-format-color-scales-conditional-formatting/color-scales.png" alt-text="Screenshot of color scale for options." lightbox="media/planning-how-to-format-color-scales-conditional-formatting/color-scales.png":::
...
* **Table wise** - Applies color scaling across the entire table using all visible values.
     ...
     :::image type="content" source="media/planning-how-to-format-color-scales-conditional-formatting/heat-map.png" alt-text="Screenshot of heat map types." lightbox="media/planning-how-to-format-color-scales-conditional-formatting/heat-map.png":::
...
* **Custom** - Lets you define custom color ranges and thresholds for conditional formatting.
     ...
     :::image type="content" source="media/planning-how-to-format-color-scales-conditional-formatting/color-scale-type.png" alt-text="Screenshot of color scale type." lightbox="media/planning-how-to-format-color-scales-conditional-formatting/color-scale-type.png":::
...
:::image type="content" source="media/planning-how-to-format-color-scales-conditional-formatting/background-color-scales.png" alt-text="Screenshot of background color scales." lightbox="media/planning-how-to-format-color-scales-conditional-formatting/background-color-scales.png":::
...
:::image type="content" source="media/planning-how-to-format-color-scales-conditional-formatting/data-bars.png" alt-text="Screenshot of data bars." lightbox="media/planning-how-to-format-color-scales-conditional-formatting/data-bars.png":::
...
:::image type="content" source="media/planning-how-to-format-color-scales-conditional-formatting/bubble-charts.png" alt-text="Screenshot of bubble charts." lightbox="media/planning-how-to-format-color-scales-conditional-formatting/bubble-charts.png":::
...
:::image type="content" source="media/planning-how-to-format-color-scales-conditional-formatting/action-dots.png" alt-text="Screenshot of action dots." lightbox="media/planning-how-to-format-color-scales-conditional-formatting/action-dots.png":::
