...
* Data in a [Fabric SQL database](../../database/sql/overview.md), and a [connection to your existing database](planning-how-to-create-database-connection.md#connect-plan-to-existing-data)
