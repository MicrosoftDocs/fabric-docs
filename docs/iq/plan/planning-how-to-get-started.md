...
> [!NOTE]
> You can find the required tenant and capacity settings, as well as all other prerequisites, here: [Prerequisites for Plan](overview-prerequisites-for-plan.md).
