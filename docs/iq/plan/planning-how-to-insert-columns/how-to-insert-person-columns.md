...
1. Select users from the list by typing a name to search or by scrolling to find the required user.

    :::image type="content" source="../media/planning-how-to-insert-columns/how-to-insert-person-columns/add-user.png" alt-text="Screenshot of adding a user to the person column." lightbox="../media/planning-how-to-insert-columns/how-to-insert-person-columns/add-user.png":::

1. Select one or more users as needed.
1. Press **Enter** to save.

The selected usernames appear in the column.

:::image type="content" source="../media/planning-how-to-insert-columns/how-to-insert-person-columns/selected-user-names.png" alt-text="Screenshot of person column with selected user names." lightbox="../media/planning-how-to-insert-columns/how-to-insert-person-columns/selected-user-names.png":::
