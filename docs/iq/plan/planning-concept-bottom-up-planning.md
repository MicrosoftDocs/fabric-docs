...
Bottom-up planning helps your organization create accurate, data-driven plans by capturing planning values at the most detailed level of the business hierarchy. You can create or update planning values at a lower hierarchy level, and the planning model automatically consolidates those values into higher-level summaries. This approach gives decision-makers visibility into organizational performance.

Use bottom-up planning to leverage operational insights, improve forecast accuracy, and create reliable plans that reflect real business activities across the enterprise.
...
1. Evaluate the planning hierarchy.
1. Aggregate planning values to parent hierarchy members.
1. Review, refine, and finalize the consolidated planning results.
...
Bottom-up planning helps your organization:
...
- Estimate demand by warehouse or distribution center.
