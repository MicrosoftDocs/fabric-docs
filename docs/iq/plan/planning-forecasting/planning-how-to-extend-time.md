...
* You haven't created forecasts.

## Extend timelines for data input measures

1. Select **Extend Time**.
1. Select the start and end periods to extend data input measures to the specified time range.

    :::image type="content" source="../media/planning-forecasting/planning-how-to-extend-time/extend-time-data-input.png" alt-text="Screenshot of time extension for data input measures." lightbox="../media/planning-forecasting/planning-how-to-extend-time/extend-time-data-input.png":::
