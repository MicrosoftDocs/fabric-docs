...
1. Close the completed forecast period.
1. The closed period is no longer available for forecast updates.
1. Extend the forecast horizon to open a new period for planning.
1. Use reforecasting to input the newly opened period with values from an existing period, if needed.
