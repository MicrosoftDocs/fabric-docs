...
1. Select **Create a connection** from the connection list.
    ...
    :::image type="content" source="media/planning-how-to-create-semantic-model-connection/connection.png" alt-text="Screenshot the manage connection gateways settings.":::
