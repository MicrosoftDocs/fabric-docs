...
description: Learn about aggregation and statistical functions in Plan and how to use them to aggregate values and perform statistical calculations.
ms.date: 06/03/2026
ms.topic: reference
...
In Plan, aggregation and statistical functions help you create calculations for scenarios such as performance analysis, trend evaluation, ranking comparisons, and statistical reporting.
