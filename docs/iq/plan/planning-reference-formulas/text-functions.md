...
description: Learn about text formatting functions in Plan and how to use them to manipulate, format, and transform text values in sheet.
ms.date: 06/03/2026
ms.topic: reference
...
In Plan, text formatting functions help you manipulate, format, and transform text values in the planning sheet. These functions can be used to combine text, extract characters, change letter casing, format values as text, clean text data, and create dynamic text-based calculations for reports and business scenarios.
