...
:::image type="content" source="../media/planning-writeback/planning-how-to-customize-general-settings/writeback-additional-column-in-destination-database.jpg" alt-text="Screenshot of writeback with additional column in destination page." lightbox="../media/planning-writeback/planning-how-to-customize-general-settings/writeback-additional-column-in-destination-database.jpg":::
