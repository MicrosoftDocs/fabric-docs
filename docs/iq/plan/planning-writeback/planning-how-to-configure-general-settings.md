...
:::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-type.jpg" alt-text="Screenshot of writeback type." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-type.jpg":::
...
* **Long** is the default writeback type. This setting stores each cell in a measure as a key-value pair. Only **Long** supports writing back comments and notes.
    ...
    :::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-type-long.jpg" alt-text="Screenshot of writeback type long." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-type-long.jpg":::
...
* **Wide** stores measures as columns. As additional measures are added, the writeback table automatically adds corresponding columns. Totals and subtotals aren't written back in **Wide** format.
    ...
    :::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-type-wide.jpg" alt-text="Screenshot of writeback type wide." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-type-wide.jpg":::
...
* **Long with changes** uses delta writeback. Only modified values are written back. The original values are stored in **PreviousValue**, and new values are stored in **Value**. The system also sets `IsLatest = 1` to identify the latest row. Delta writeback works for both numeric and text data type adjustments.
    ...
    :::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-type-long-with-changes.jpg" alt-text="Screenshot of writeback type long with changes." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-type-long-with-changes.jpg":::
...
* **Wide with changes** uses delta writeback, but each measure is stored in a separate column. It maintains change history and uses `IsLatest` to identify the active record.
    ...
    :::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-type-wide-with-changes.jpg" alt-text="Screenshot of writeback type wide with changes." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-type-wide-with-changes.jpg":::
...
:::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-filter-type.png" alt-text="Screenshot of writeback filter type." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-filter-type.png":::
...
:::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-additional-column-configuration.png" alt-text="Screenshot of writeback with additional coloumn configuration." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-additional-column-configuration.png":::
...
:::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-additional-column-in-destination-database.jpg" alt-text="Screenshot of writeback with additional column in destination page." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-additional-column-in-destination-database.jpg":::
...
:::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-configured-decimal-precision.jpg" alt-text="Screenshot of writeback settings configured with decimal precision." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-configured-decimal-precision.jpg":::
...
:::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-text-field-length.png" alt-text="Screenshot of writeback settings with text length' text length." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-text-field-length.png":::

The **Text Length** section in writeback settings shows the set text length as follows.

:::image type="content" source="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-configured-text-length.png" alt-text="Screenshot of writeback settings configured with text length' text length." lightbox="../media/planning-writeback/planning-how-to-configure-general-settings/writeback-configured-text-length.png":::
