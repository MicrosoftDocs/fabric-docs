...
Before you set up Planning sheets, make sure you have the following prerequisite in place:

* Create your individual connections or data sources to connect with a Fabric SQL database and Power BI semantic model.
...
You can share the created connection and manage the user permissions. Select **Manage users**.
