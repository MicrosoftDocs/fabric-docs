...
1. Go to **Data Input** > **Enable Multi-Dimension Allocation**. Select **Add Breakdown**.
    ...
    :::image type="content" source="media/planning-how-to-create-cube/add-breakdown.png" alt-text="Screenshot of creating a cube." lightbox="media/planning-how-to-create-cube/add-breakdown.png":::
...
1. The row dimensions in the current planning sheet are automatically added in the first breakdown.
    ...
    :::image type="content" source="media/planning-how-to-create-cube/add-breakdown-dimensions.png" alt-text="Screenshot of configuring breakdown dimensions." lightbox="media/planning-how-to-create-cube/add-breakdown-dimensions.png":::
...
1. Select **Add** to create new dimension breakdowns.
    ...
    :::image type="content" source="media/planning-how-to-create-cube/add-multiple-breakdowns.png" alt-text="Screenshot of configuring additional breakdown dimensions.":::

1. Create the breakdown and create the measure.
1. After a cube measure is created, it is added under **Data** > **From Sheets** > **Cube**.
...
:::image type="content" source="media/planning-how-to-create-cube/insert-cube-measure.png" alt-text="Screenshot of inserting a cube measure." lightbox="media/planning-how-to-create-cube/insert-cube-measure.png":::

The cube measure is imported into the planning sheet, and allocations are based on the configured breakdowns.

:::image type="content" source="media/planning-how-to-create-cube/insert-cube-measure.png" alt-text="Screenshot of cube measure used in another report." lightbox="media/planning-how-to-create-cube/insert-cube-measure.png":::
...
* _Restrict input using **Allow Input – Based on Formula**_: To prevent users from entering or allocating values on invalid intersections, configure an input rule such as `[Driver Measure]!==BLANK`.

   :::image type="content" source="media/planning-how-to-create-cube/validation-formula.jpg" alt-text="Screenshot of the validation formula.":::
