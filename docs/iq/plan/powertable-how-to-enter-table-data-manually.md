...
1. Select **Next**.
    ...
    :::image type="content" source="media/powertable-how-to-enter-table-data-manually/select-database.jpg" alt-text="Screenshot of selecting the schema and entering the table name." lightbox="media/powertable-how-to-enter-table-data-manually/select-database.jpg":::
...
1. Select **Finish** after entering all the column details.
    ...
    :::image type="content" source="media/powertable-how-to-enter-table-data-manually/finish-table.png" alt-text="Screenshot of selecting Finish after configuring all the column names for the new table." lightbox="media/powertable-how-to-enter-table-data-manually/finish-table.png":::

1. An empty table is successfully created using PowerTable, with the configured columns.

    :::image type="content" source="media/powertable-how-to-enter-table-data-manually/empty-table.png" alt-text="Screenshot of the new empty table with configured columns." lightbox="media/powertable-how-to-enter-table-data-manually/empty-table.png":::

1. You can now insert rows into this table using the **Insert Row** option.

    :::image type="content" source="media/powertable-how-to-enter-table-data-manually/insert-rows.png" alt-text="Screenshot of inserting rows to the empty table." lightbox="media/powertable-how-to-enter-table-data-manually/insert-rows.png":::

1. Select **Preview Changes** to preview the added rows and changes.

    :::image type="content" source="media/powertable-how-to-enter-table-data-manually/preview-changes.png" alt-text="Screenshot of preview with added rows and changes." lightbox="media/powertable-how-to-enter-table-data-manually/preview-changes.png":::
