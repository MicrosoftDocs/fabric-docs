...
Use the **Run History** pane to monitor workflow executions and review the status of each run. You can see the users who initiated the automations, when they initiated, duration and time of automation, and whether it succeeded or failed.
