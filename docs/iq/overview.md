...
* **Empower AI agents.** Fabric IQ provides structured grounding for copilots and agents, so answers reflect your enterprise language as defined in your [ontology (preview)](ontology/overview.md).
...
| Plan | Collaborate on planning, forecasting, and reporting from a single data foundation without switching tools. Use plan to bring together business planning, analytics, and data management in one no-code experience. | [What is plan?](plan/overview.md) |
...
* **All items together:** Semantic models deliver trusted KPIs; ontology (preview) defines shared business language for those KPIs; Graph powers relationship and impact analysis; plan turns insights into coordinated actions; and data and operations agents provide intelligent, concept-aware interactions over live and historical data.
