...
1. On the **Connect to data source** screen, select the **Upload file** radio button. Drag and drop or browse to the *dimension_customer.csv* file that you downloaded in step 1. After the file is uploaded, select **Next**.
