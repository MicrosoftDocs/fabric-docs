...
description: Use the VS Code extension for Fabric Data Engineering and explore Fabric Spark environments with Visual Studio Code.
ms.reviewer: qixwang
ms.topic: overview
ms.date: 07/29/2024
...
:::image type="content" source="media\vs-code\set-default-env.png" alt-text="Screenshot showing change workspace default environment." lightbox="media\vs-code\set-default-env-expanded.png":::
...
:::image type="content" source="media\vs-code\check-env-association.png" alt-text="Screenshot showing check environment association." lightbox="media\vs-code\check-env-association.png":::
