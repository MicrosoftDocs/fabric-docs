...
You can request multiple aggregation metrics in one query. For example use the following query to get the total price of all products and the average rating for each category:
