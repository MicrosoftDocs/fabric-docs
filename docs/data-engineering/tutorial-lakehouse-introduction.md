...
1. Sign in to your Power BI account and sign up for the free [Microsoft Fabric trial](../get-started/fabric-trial.md).If you don't have a Fabric (Free) license, [sign up for a Power BI free license](https://app.fabric.microsoft.com/?pbi_source=learn-data-engineering-tutorial-lakehouse-introduction) and then you can start the Fabric trial.
