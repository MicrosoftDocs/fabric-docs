...
For customized libraries, you can upload the lib files to the [**Built-in resources**](#notebook-resources-folder) folder. We support multiple types of libraries, like *.whl*, *.jar*, *.dll*, *.py* and etc. Just try drag&drop to the file and the code snippet is generated automatically.
