...
| Connections | Connector type (Linked services) <br>Data Sources ([13](https://learn.microsoft.com/azure/synapse-analytics/spark/apache-spark-secure-credentials-with-tokenlibrary?pivots=programming-language-python)) <br>Data Source conn. with workspace identity | Connector type (DMTS*) <br>Data Sources ([Dataflow Gen2](https://learn.microsoft.com/power-query/connectors/)) <br>Data Source conn. with workspace identity ([Planned](https://learn.microsoft.com/fabric/release-plan/admin-governance#ds-connectivity)) |
| Security | RBAC and access control (11 roles at workspace level) <br>Storage ACLs (ADLS Gen2) <br>Private Links <br>Managed VNet (Network Isolation) <br>Fabric Workspace Identity (FWI) <br>Data Exfiltration Protection <br>IP Firewall <br>Trusted Service for Storage Firewall bypass (with workspace identity) <br>Service Tags <br>- <br>Key Vault (via mssparkutils and Linked service) | RBAC and access control (4 roles at workspace level) <br>Storage ACLs (Lakehouse security ([planned](https://learn.microsoft.com/fabric/release-plan/data-engineering#security))) <br>Private Links ([Planned (only Control Plane)](https://learn.microsoft.com/fabric/release-plan/admin-governance#private-link)) <br>- <br>Fabric Workspace Identity (FWI) <br>- <br>- (only Control Plane) <br>Trusted Service for Storage Firewall bypass ([Planned](https://learn.microsoft.com/fabric/release-plan/admin-governance#fabric-azure-storage)) <br>Service Tags <br>Policy Management-Spark pools ([Planned](https://learn.microsoft.com/fabric/release-plan/data-engineering#policy)) <br>Key Vault (via mssparkutils (public endpoint)) |
| DevOps | Azure DevOps integration <br>CI/CD (No built-in support) | Azure DevOps integration ([Planned](https://learn.microsoft.com/fabric/release-plan/data-engineering#dit)) <br>CI/CD (Deployment pipelines-[planned](https://learn.microsoft.com/fabric/release-plan/data-engineering#pipelines))|
...
| BC, HA & Disaster Recovery | BCDR (data)-via ADLS Gen2 | BCDR (data)-OneLake ([planned](https://learn.microsoft.com/fabric/release-plan/admin-governance#disaster-recovery)) |
