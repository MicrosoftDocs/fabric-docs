...
For more information, see [Fabric Notebook User Data Functions utilities](../notebookutils/notebookutils-udf.md).
...
- [Fabric Notebook utilities](../notebookutils/notebookutils-udf.md) - Reference for calling functions from notebooks
