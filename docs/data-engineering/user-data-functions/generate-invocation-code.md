...
For more information, see [Fabric Notebook User Data Functions utilities](../notebook-utilities/notebook-utilities-udf.md).
...
- [Fabric Notebook utilities](../notebook-utilities/notebook-utilities-udf.md) - Reference for calling functions from notebooks
