...
:::image type="content" source="media\vs-code\open-notebook-in-vs-code-vfs-mode.png" alt-text="Screenshot showing how to open a notebook in VS Code under VFS mode." lightbox="media\vs-code\open-notebook-in-vs-code-vfs-mode.png":::
