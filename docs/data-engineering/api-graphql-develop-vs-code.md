---
title: Develop GraphQL Applications on VS Code
description: Learn how to develop GraphQL applications in VS Code using local development tools including autocompletion, code generation, and IntelliSense.
ms.reviewer: sngun
ms.author: sngun
author: edlima
ms.topic: how-to
