...
> [!NOTE]
> The local file system cache lasts 120 seconds by default. You can change this by setting the [*fileCacheTimeout*](#mount-via-shared-access-signature-token-or-account-key) parameter.
