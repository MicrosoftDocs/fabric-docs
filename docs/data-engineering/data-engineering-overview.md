...
Microsoft Fabric provides various data engineering capabilities to ensure that your data is easily accessible, well-organized, and of high-quality.

To access the data engineering homepage, select **Workloads** from the navigation pane, then select the **Data Engineering** tile. From the data engineering homepage, you can:
