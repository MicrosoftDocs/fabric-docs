...
1. Open your lakehouse and select **Manage materialized lake views (preview)**.
...
1. Close the notebook and go back to your lakehouse. Select **Manage materialized lake views (preview)**. You might need to select the refresh icon to view the autogenerated lineage.
...
1. Schedule the lineage execution. Select **Schedules** from the top ribbon. In the **Schedules** pane, select the **On** radio button for **Schedule refresh**. Select the desired frequency from the **Repeat** drop-down (by the minute, hourly, daily, weekly, or monthly) and specify the recurring interval. Select **Apply**.
...
1. Wait for the next scheduled run time. Select the ongoing run to monitor progress.
