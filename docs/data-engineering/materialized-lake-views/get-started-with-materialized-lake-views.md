...
1. Close the notebook and go back to your Lakehouse. Select **Materialized lake views** and select **Manage**. You might need to select the refresh icon to view the autogenerated lineage.
...
1. Schedule the lineage execution. Select **Manage schedules** from the ribbon. In the **Manage schedules** pane, select the **New schedule** button to create a schedule. Turn the radio button for **Schedule refresh** to **On** state. 
...
1. Select the materialized views to be refreshed, choose the desired **Refresh type**, configure the settings to be used for refresh and save it.
...
1. Go to the **Recent run(s)** page to see the progress of the lineage execution.
...
1. Select an ongoing run to monitor its progress.
...
1. Once the run is completed, the lineage status gets updated.
