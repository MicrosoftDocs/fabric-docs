...
In this package, the manifest is located here:  [Frontend Manifest file](./Manifests/localWorkloadManifest.json)  (and a detailed description can be found [here](./frontendManifest.md)
...
### Authentication
 ...
 In localWorkloadManifest.json, you will need to configure your aad config under "extension":
