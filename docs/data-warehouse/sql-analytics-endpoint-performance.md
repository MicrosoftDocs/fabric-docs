...
- Not all Delta features are understood by the automatic sync process.  This [document](https://learn.microsoft.com/en-us/fabric/get-started/delta-lake-interoperability) details the functionality supported by each engine in Fabric.
