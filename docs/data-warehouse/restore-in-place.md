...
To restore a warehouse in-place, choose a restore point and issue a restore command. For an example, you can [use the third-party POSTMAN tool with steps detailed in this Fabric blog]():
