...
In [!INCLUDE [product-name](../includes/product-name.md)], there are multiple types of statistics that automatically generated by the engine to improve query plan costing. Currently, they can be found in [sys.stats](/sql/relational-databases/system-catalog-views/sys-stats-transact-sql?view=fabric&preserve-view=true) although not all are actionable:
...
2. Average column length statistics
    ...
    - Contents cannot be viewed and are non-actionable by user
