...
Within fabric, there are users who might need to decide between a [Warehouse](create-warehouse.md), [Lakehouse](get-started-lakehouse-sql-endpoint.md), and even a [Power BI datamart](../data-engineering/create-lakehouse.md).
