...
You can manually force a refresh of the automatic metadata scanning in the Fabric portal. On the page for the [!INCLUDE [fabric-se](includes/fabric-se.md)], select the **Refresh** button in the toolbar to refresh the schema.

:::image type="content" source="media/data-warehousing/sql-endpoint-refresh-button.png" alt-text="Screenshot from the Fabric portal showing the SQL analytics endpoint Refresh schema button." lightbox="media/data-warehousing/sql-endpoint-refresh-button.png":::
