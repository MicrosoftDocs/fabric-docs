...
1. Select **Copy SQL connection string** to copy the connection string to your clipboard.
   ...
   :::image type="content" source="media\connectivity\warehouse-copy-sql-connection-string.png" alt-text="Screenshot of the workspace screen with the context menu open." lightbox="media\connectivity\connectionstringws.png":::
