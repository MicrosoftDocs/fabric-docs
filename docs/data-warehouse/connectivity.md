...
- If you receive error code 6008 with the message "Workspace is temporarily unavailable. This may be due to system maintenance or an internal operation. Please reestablish your connection." this indicates a temporary connection interruption. To resolve this issue, reestablish your connection, sign in again, and retry the operation. This condition is transient and does not indicate a failure in your query or application.
