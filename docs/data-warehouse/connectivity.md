...
The DBT Fabric DW  Adapter supports AAD based authentication and allows developers to use az cli authentication using dbt-synapsevnext adapter. FYI, SQL Authentication is not supported.
