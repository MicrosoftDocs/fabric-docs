...
1. After selecting **Table**, an autogenerated [CREATE TABLE](/sql/t-sql/statements/create-table-azure-sql-data-warehouse?view=fabric&preserve-view=true) script appears in your new SQL query window, as shown in the following image.
...
1. Modify the `CREATE TABLE` template to suit your new table, then select **Run** to create the table.
