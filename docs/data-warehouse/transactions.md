...
- At this time, there's limited T-SQL functionality in the warehouse. See [TSQL surface area](t-sql-surface-area.md) for a list of T-SQL commands that are currently not available.
