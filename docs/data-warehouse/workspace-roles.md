...
|**Viewer**|Grants the user Connect permissions for each Warehouse within the workspace. Viewers can be granted granular SQL permissions to read data from tables/views can be provided using T-SQL. For more information, see Manage SQL granular permissions.|
