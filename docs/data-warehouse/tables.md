...
- Table data types are automatically chosen in the [!INCLUDE [fabric-se](includes/fabric-se.md)] of the Lakehouse, see [Autogenerated data types](data-types.md#autogenerated-data-types).
