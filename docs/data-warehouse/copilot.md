...
Copilot in Fabric Data Warehouse uses table and view names, column names, primary key, and foreign key metadata to generate T-SQL code. Copilot in Fabric Data Warehouse doesn't use data in tables to generate T-SQL suggestions.
...
- **[Copilot chat pane](copilot-chat-pane.md)**: Use the chat pane to ask questions to Copilot through natural language. Copilot responds with a generated SQL query or natural language based on the question asked.
  - **Natural Language to SQL**: Generate T-SQL code and get suggestions of questions to ask to accelerate your workflow.

- **[Copilot code completion](copilot-code-completion.md)**: Start writing T-SQL in the SQL query editor and Copilot automatically generates a code suggestion to help complete your query. The **Tab** key accepts the code suggestion, or keeps typing to ignore the suggestion.

- **[Copilot quick actions](copilot-quick-action.md)**: In the ribbon of the SQL query editor, the **Fix** and **Explain** options are quick actions. Highlight a SQL query of your choice and select one of the quick action buttons to perform the selected action on your query.
  - **Explain:** Copilot can provide natural language explanations of your SQL query and warehouse schema in comments format.
  - **Fix:** Copilot can fix errors in your code as error messages arise. Error scenarios can include incorrect or unsupported T-SQL code, wrong spellings, and more. Copilot also provides comments that explain the changes and suggest SQL best practices.
...
- When crafting prompts, start with a clear and concise description of the specific information you're looking for.
...
- Use natural language that applies to your table and view names, column names, primary keys, and foreign keys of your warehouse. This context helps Copilot generate accurate queries. Specify what columns you want to see, aggregations, and any filtering criteria as explicitly as possible. Copilot should be able to correct typos or understand context given your schema context.
...
To view Microsoft's guidelines for responsible AI in Fabric Data Warehouse, see [Privacy, security, and responsible AI use of Copilot](../fundamentals/copilot-data-warehouse-privacy-security.md).
...
- Copilot doesn't understand previous inputs and can't undo changes after a user commits a change when authoring, either through the user interface or the chat pane. For example, you can't ask Copilot to *Undo my last five inputs.* However, you can still use the existing user interface options to delete unwanted changes or queries.
...
- Copilot might produce inaccurate results when the intent is to evaluate data. Copilot only has access to the warehouse schema, and none of the data inside.
- Copilot responses can include inaccurate or low-quality content, so ensure you review outputs before using them in your work.
- People who can meaningfully evaluate the content's accuracy and appropriateness should review the outputs.

## Related content

- [Copilot and Agent tenant settings](../admin/service-admin-portal-copilot.md)
- [How to use the Copilot chat pane in Fabric Data Warehouse (Preview)](copilot-chat-pane.md)
- [How to use Copilot quick actions in Fabric Data Warehouse (Preview)](copilot-quick-action.md)
- [How to Use Copilot code completion in Fabric Data Warehouse (Preview)](copilot-code-completion.md)
- [Privacy, security, and responsible AI use of Copilot in Fabric in the Data Warehouse workload (Preview)](../fundamentals/copilot-data-warehouse-privacy-security.md)
