...
- When you are running a SQL query with [USE (Transact-SQL)](/sql/t-sql/language-elements/use-transact-sql), you need to submit the SQL query with [USE (Transact-SQL)](/sql/t-sql/language-elements/use-transact-sql) as one single request. 
